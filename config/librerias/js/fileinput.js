...
(function ($) {
    ...
    $.fn.fileinput.defaults = {
        ...
        browseIcon: '<i class="material-icons" style="font-size:15px;color:white">search</i> &nbsp;',
        browseClass: 'btn btn-primary',
        removeLabel: 'Eliminar',
        removeIcon: '<i class="material-icons" style="font-size:15px;color:white">highlight_off</i> ',
        removeClass: 'btn btn-default',
        uploadLabel: 'Subir',
        uploadIcon: '<i class="material-icons" style="font-size:15px;color:black">cloud_upload</i> ',
        uploadClass: 'btn btn-default',
        uploadUrl: null,
        msgLoading: 'Cargando &hellip;',
        msgProgress: 'Cargado {percent}% de {file}',
        msgSelected: '{n} Imágenes seleccionadas',
